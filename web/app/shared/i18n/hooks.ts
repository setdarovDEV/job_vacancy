...
import type { Glass, Theme } from "../theme/theme";

type RootData = { locale: Locale; theme: Theme; glass: Glass; hasSession: boolean };

export function useRootData(): RootData {
  return (useRouteLoaderData("root") as RootData | undefined) ?? { locale: defaultLocale, theme: "system", glass: "auto", hasSession: false };
}
